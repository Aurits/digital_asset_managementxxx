...
$sup .= "</select>";
?>
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-secondary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-secondary">Add Asset</h4>
            </div>
            <a href="product.php?action=add" type="button" class="btn btn-secondary bg-gradient-secondary">Exit</a>
            <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <form role="form" method="post" action="pro_transac.php?action=add">
                           ...
                           <!-- <div class="form-group">
                              <input type="number"  min="1" max="9999999999" class="form-control" placeholder="Price" name="price">
                            </div>-->
                            <div class="form-group">
                              <?php
                                echo $opt;
                            ...
                            <button type="reset" class="btn btn-warning btn-block"><i class="fa fa-times fa-fw"></i>Reset</button>
