...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    ...
    , product.CATEGORY_ID, product.PRODUCT_CODE, product.NAME, product.PRICE, category.CNAME, product.QTY_STOCK, product.DATE_STOCK_IN, product.DESCRIPTION, product.ON_HAND, product.SUPPLIER_ID
              FROM product
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action="pro_transac.php?action=add">
          ...
          <div class="form-group">
            <input type="file" min="1" max="9999999999" class="form-control" placeholder="Price" name="file" required>
          </div>
          <div class="form-group">
            <?php
            echo $aaa;
