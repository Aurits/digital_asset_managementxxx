...
<center>
  <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
    <div class="card-header py-3">
      <h4 class="m-2 font-weight-bold text-primary">Update Asset</h4>
    </div>
    ...
    <div class="card-body">
      ...
      <form role="form" method="post" action="pro_edit1.php">
        ...
        <div class="form-group row text-left text-success">
        ...
        <button type="submit" class="btn btn-success btn-block"><i class="fa fa-edit fa-fw"></i>Complete Update</button>
      </form>
    </div>
  </div>
</center>
