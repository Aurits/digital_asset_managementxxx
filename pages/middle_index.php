      ...
      <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col mr-0">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Digital Assets</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
    ...
    <div class="card shadow h-100">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          ...
          <div class="panel-heading"> Recent Assets
          </div>
            ...
            <div class="col-auto">
              <div class="h6 mb-0 mr-0 text-gray-800">
                ...
                <div class="panel-body">
                  ...
                  <!-- /.list-group -->
                  <a href="product.php" class="btn btn-default btn-block">View All Assets</a>
                </div>
                <!-- /.panel-body -->
              </div>
            </div>
