    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Asset Category</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#keyboard" data-toggle="tab">Images</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#mouse" data-toggle="tab">Videos</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#headset" data-toggle="tab">Audio</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#cpu" data-toggle="tab">Documents</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#monitor" data-toggle="tab">Presentations</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#motherboard" data-toggle="tab">Website Content</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#processor" data-toggle="tab">Stock Photography</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#powersupply" data-toggle="tab">Logos/ Brandings</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#processor" data-toggle="tab">Books</a>
                              </li>
                              <li class="nav-item">
...
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Discover Asset</h4>
        </div>
