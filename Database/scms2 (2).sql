...
CREATE TABLE `product` (
  ...
  `UPLOADNAME` varchar(200) NOT NULL DEFAULT 'file'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `product` (`PRODUCT_ID`, `PRODUCT_CODE`, `NAME`, `DESCRIPTION`, `QTY_STOCK`, `ON_HAND`, `PRICE`, `CATEGORY_ID`, `SUPPLIER_ID`, `DATE_STOCK_IN`, `UPLOADNAME`) VALUES
(29, '1234', 'Pen', 'This is a pen', 100, '1', 'description', 0, 12, '2023-08-22', 'file');
